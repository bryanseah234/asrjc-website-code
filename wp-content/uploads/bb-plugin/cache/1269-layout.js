...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5d3a60715a21f',layout:'columns',pagination:'numbers',postSpacing:'60',postWidth:'300',matchHeight:1,isRTL:false});});})(jQuery);