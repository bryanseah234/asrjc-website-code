...
e.preventDefault();if(accordion.hasClass('fl-accordion-collapse')){accordion.find('.fl-accordion-item-active').removeClass('fl-accordion-item-active');accordion.find('.fl-accordion-button').attr('aria-expanded','false');accordion.find('.fl-accordion-content').attr('aria-hidden','true');allContent.slideUp('normal');if(allIcons.find('svg').length>0){allIcons.find('svg').attr("data-icon",'plus');}else{allIcons.removeClass('fa-minus');allIcons.addClass('fa-plus');}}
if(content.is(':hidden')){button.attr('aria-expanded','true');item.addClass('fl-accordion-item-active');item.find('.fl-accordion-content').attr('aria-hidden','false');content.slideDown('normal',this._slideDownComplete);if(icon.find('svg').length>0){icon.find('svg').attr("data-icon",'minus');}else{icon.addClass('fa-minus');icon.removeClass('fa-plus');}}
else{button.attr('aria-expanded','false');item.removeClass('fl-accordion-item-active');item.find('.fl-accordion-content').attr('aria-hidden','true');content.slideUp('normal',this._slideUpComplete);if(icon.find('svg').length>0){icon.find('svg').attr("data-icon",'plus');}else{icon.addClass('fa-plus');icon.removeClass('fa-minus');}}},_focusIn:function(e)
...
{return(e.which==1||e.which==13||e.which==32||e.which==undefined)?true:false;}};})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'5b909d2d82602',defaultItem:1});});})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'5e325b99b8e74',defaultItem:1});});})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'5b90a042d225a',defaultItem:1});});})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'5b90a2bb611a5',defaultItem:1});});})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'5b90a3fdef292',defaultItem:1});});})(jQuery);